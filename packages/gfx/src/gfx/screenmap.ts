...
import { parse_screenmap_data_json, parseScreenmapMultiStrip, centerAndFitPoints, computeCenterFitScale } from '../common.js';
import type { Screenmap, ScreenmapShape } from './types.js';
