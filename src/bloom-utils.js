 ...
 */
export function stepIrisAttackDecay(currentBrightness, avgBrightness, dtSeconds, {
 ...
 *          provides one.
 */
export function resolveLedDiameter(strips, fallback = null) {
    let max = 0;
    if (strips) {
 ...
 */
export function computeFitScale(rawPts, fittedPts) {
    const extent = (pts) => {
 ...
 */
export function bloomParamsForLedSize(ledPx, panePx, ledCount, {
